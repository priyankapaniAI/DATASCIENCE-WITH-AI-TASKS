...
face_classifier = cv2.CascadeClassifier(r"C:\Users\panip\anaconda3\streamlit\computervision\haarcascade_frontalface_default.xml")
# Load the image
image = cv2.imread(r"C:\Users\panip\Pictures\duplicate1.jpg")
